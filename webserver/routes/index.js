...
var client_uri = 'http://localhost:8200';
...
router.get('/recently-played', function(req, res, next) {
    makeAPIRequest('https://api.spotify.com/v1/me/player/recently-played', res);
});
